		...
		<div id="panel-outer" class="radius" style="opacity: 1;">
			<div id="panel" class="radius">
				...
				<div id="content" class="clearfix">
					...
					<a rel="facebox" href="addemployee.php">Add employee</a>
					
					<table cellpadding="1" cellspacing="1" id="resultTable">
						<thead>
							<tr>
								<th  style="border-left: 1px solid #C1DAD7"> Employee Type </th>
								<th> Name </th>
								<th> Phone </th>
								<th> Address </th>	
								<th> Bus Id </th>
							...
							while($row = mysqli_fetch_array($result))
								{
									...
									echo '<td><div align="right">'.$row['post'].'</div></td>';
									echo '<td><div align="right">'.$row['phone'].'</div></td>';
									echo '<td><div align="right">'.$row['address'].'</div></td>';
									echo '<td><div align="right">'.$row['bus_id'].'</div></td>';

									echo '<td><div align="center"><a rel="facebox" href="editempdetails.php?id='.$row['id'].'">edit</a> | <a href="#" id="'.$row['id'].'" class="delbutton" title="Click To Delete">delete</a></div></td>';
									echo '</tr>';
								}
							?> 
						</tbody>
